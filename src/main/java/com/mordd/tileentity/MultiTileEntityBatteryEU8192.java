...
public class MultiTileEntityBatteryEU8192 extends TileEntityBase08Battery {
    ...
    public static IIconContainer[] sTextures = new IIconContainer[] {
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/8192/bottom"),
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/8192/top"),
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/8192/sides"),
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/8192/bar"),
    };
    @Override
    ...
    public String getTileEntityName() {
        return "vd.multitileentity.battery.eu.8192";
    }
}