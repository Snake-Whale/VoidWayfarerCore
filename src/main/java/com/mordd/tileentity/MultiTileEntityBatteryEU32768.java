...
public class MultiTileEntityBatteryEU32768 extends TileEntityBase08Battery {
    @Override
    ...
    public static IIconContainer[] sTextures = new IIconContainer[] {
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/32768/bottom"),
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/32768/top"),
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/32768/sides"),
            new Textures.BlockIcons.CustomIcon("vd_core:machines/batteries/eu/ultra/32768/bar"),
    };
    @Override
    ...
    public String getTileEntityName() {
        return "vd.multitileentity.battery.eu.32768";
    }
}